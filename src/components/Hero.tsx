...
export default function Hero() {
  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img src={heroBg} alt="Luxury wellness resort for dental tourism recovery" className="w-full h-full object-cover" />
        <div className="absolute inset-0 bg-gradient-to-b from-foreground/40 via-foreground/20 to-background" />
      </div>

      {/* Floating Decorative Elements */}
      <motion.div className="absolute top-1/4 left-10 w-20 h-20 rounded-full bg-primary/20 blur-2xl" animate={{
      y: [0, -20, 0],
      opacity: [0.5, 0.8, 0.5]
    }} transition={{
      duration: 6,
      ...
      <motion.div className="absolute bottom-1/3 right-10 w-32 h-32 rounded-full bg-secondary/20 blur-3xl" animate={{
      y: [0, 20, 0],
      opacity: [0.3, 0.6, 0.3]
    }} transition={{
      duration: 8,
      ...
      <div className="relative z-10 container mx-auto px-6 py-32 text-center">
        ...
        {/* Scroll Indicator */}
        <motion.button onClick={() => scrollToSection("#why-india")} initial={{
        opacity: 0
      }} animate={{
        opacity: 1
      }} transition={{
      ...
      <div className="absolute bottom-0 left-0 right-0">
        <svg viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full" preserveAspectRatio="none">
          <path d="M0 120L60 110C120 100 240 80 360 70C480 60 600 60 720 65C840 70 960 80 1080 85C1200 90 1320 90 1380 90L1440 90V120H1380C1320 120 1200 120 1080 120C960 120 840 120 720 120C600 120 480 120 360 120C240 120 120 120 60 120H0Z" fill="hsl(200 33% 98%)" />
        </svg>
      </div>
    </section>;
}